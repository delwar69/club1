"""
Django settings for btv_officers_club project.
...
SECRET_KEY = 'django-insecure-zk%279_yud(zm2ux^_6z2+8(k%y^q@jg+eyaba3mn)^%*kun%6'
...
ROOT_URLCONF = 'btv_officers_club.urls'
